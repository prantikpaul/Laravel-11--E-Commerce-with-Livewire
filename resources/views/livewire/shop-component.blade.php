            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <script>
                            // Automatically hide the alerts after 3 seconds
                            document.addEventListener('DOMContentLoaded', function () {
                                setTimeout(() => {
                                    // Success alert removal
                                    const successAlert = document.getElementById('success-alert');
                                    if (successAlert) {
                                        successAlert.style.transition = 'opacity 0.5s ease-in-out'; // Smooth fade-out
                                        successAlert.style.opacity = '0'; // Set opacity to 0 to fade out
                                    ...
                                    if (errorAlert) {
                                        errorAlert.style.transition = 'opacity 0.5s ease-in-out'; // Smooth fade-out
                                        errorAlert.style.opacity = '0'; // Set opacity to 0 to fade out
...
{{--                                            <button aria-label="Add To Cart" class="action-btn hover-up" wire:click.prevent="store({{ $p->id }})"><i class="fi-rs-shopping-bag-add"></i></button>--}}
                                            <button
                                                aria-label="Add To Cart"
                                                class="action-btn hover-up"
                                                wire:click.prevent="store({{ $p->id }}, 1)">
