                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        @if($related_p->isEmpty())
                                            <div class="col-12">
                                                <p>No product found.</p>
                                            </div>
                                        @else

                                        @foreach($related_p as $rp)
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{$rp->image}}" alt="">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="product-details.html" tabindex="0">{{$rp->name}}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>৳{{$rp->sale_price}} </span>
                                                        <span class="old-price">৳{{$rp->regular_price}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
